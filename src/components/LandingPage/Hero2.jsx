...
import hero2Social from "../../assets/hero2Social.png";
const Hero2 = () => {
  return (
    <div className={styles.hero2}>
      <div className={styles.hero2Headings}>
        <h1 className={styles.hero2Heading}>
      ...
      <div className={styles.hero2part}>
        <div className={styles.left}>
          <div className={styles.subHeading}>
            <h1 style={{ marginBottom: "10px", background: "none" }}>
          ...
          <div className={styles.subHeading}>
            <h1 style={{ marginBottom: "10px", background: "none" }}>CLOSE</h1>
            <p style={{ background: "none" }}>
        ...
        <div className={styles.right}>
          ...
          />
          <img src={hero2} alt="" className={styles.cup} />
        </div>
      </div>
    </div>
  );
